...
@click.command()
@click.option("-s", type=str, default=None, help="Specify search term")
@click.option("-m", type=str, default=None, help="Sepcify selection")
@click.option("-w", type=str, default=None, help="Output search list to file")
@click.option(
    "-n",
    "--no-patience",
    is_flag=True,
    help=
    "Deactivate -n flag (default) to prevent overwriting files which should not have been overwritten (possibly slower due to more network usage)"
)
@click.option("--dump",
              type=str,
              default=None,
